  ...
  return (
    <div className="container main">
        ...
        <div>
          ...
          <ul>
            <li>
              Abalam olarak, müşterilerimize hızlı ve güvenilir bir teslimat hizmeti sunmak bizim için önemlidir. Siparişlerinizi en kısa sürede ve güvenli bir şekilde sizlere ulaştırmak için özen gösteriyoruz.
            </li>
            <li>

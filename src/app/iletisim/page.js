...
function Page() {
  return (
    <div>
                            ...
                            <div className="contact-info ">
                                <div className="contact-item">
                                    ...
                                    <div className="contact-text">
                                        <h5>Adres</h5>
                                          <p>
                                            Esentepe, Küçük San. Sit. 2950. Sk., 34265 Sultangazi/İstanbul
                                          </p>
                                    </div>
                                </div>
                                <div className="contact-item">
      ...
      <div className='container'>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3006.815164947082!2d28.877428876141565!3d41.094884971338466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cab034d7f1ed7f%3A0x78edfa733792bb80!2sSonu%C3%A7%20Plastik!5e0!3m2!1str!2str!4v1691635426821!5m2!1str!2str"  width="100%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>
  )
}
